...
The web interface is designed for replay and analysis of pre-processed chess games and does not perform live detection.
...
The web interface will load the recorded chess video and replay detected moves in synchronization with the video timeline.

Notes:

The frontend expects a valid moves.json file generated by the detection pipeline.

Video files are loaded locally and are not tracked in the repository.

This interface is intended for replay and analysis, not live detection.
